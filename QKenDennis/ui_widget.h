...
public:
    ...
    QPushButton *pb_interfaceCustomization_2;
...
"}"));
        ...
        pb_interfaceCustomization->setGeometry(QRect(20, 220, 111, 41));
        ...
        pb_netWork->setGeometry(QRect(20, 160, 111, 41));
        ...
        pb_sqlManager->setGeometry(QRect(20, 90, 111, 41));
        pb_sqlManager->setStyleSheet(QStringLiteral("border-image: url(:/image/bt_normal.png);"));
        pb_interfaceCustomization_2 = new QPushButton(widget);
        pb_interfaceCustomization_2->setObjectName(QStringLiteral("pb_interfaceCustomization_2"));
        pb_interfaceCustomization_2->setGeometry(QRect(20, 280, 111, 41));
        pb_interfaceCustomization_2->setStyleSheet(QStringLiteral("border-image: url(:/image/bt_normal.png);"));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        pb_interfaceCustomization_2->setText(QApplication::translate("Widget", "\350\247\206\351\242\221\346\222\255\346\224\276\345\231\250", Q_NULLPTR));
    } // retranslateUi
